            ...
            <div className="panel panel-default">
                ...
                <div className="panel-body">
                    <div className="mb-3">
                        ...
                        <input type="email" className="form-control" id="emailFormControl" placeholder="cine@gmail.com" autoFocus autoComplete='off' />
                    </div>
                    <div className="mb-3">
                ...
                <div className="panel-footer d-flex justify-content-end align-items-center">
                    ...
                    <button className='btn btn-primary' onClick={(e)=>handlerSendMailer(e,item)}>
                        Enviar correo
                    </button>
