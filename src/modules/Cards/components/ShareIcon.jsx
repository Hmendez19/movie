const ShareIcon = () => {
    return <>
        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className="share-icon"
            width="483px" height="483px" viewBox="0 0 483 483" style={{ height: "25px", width: "25px" }} title="Compartir pelicula">
            <g>
		...
		c48.203,0,87.281-39.078,87.281-87.281C482.999,39.079,443.923,0,395.72,0z" fill='#505088' />
            </g>
            <g>
            </g>
            <g>
